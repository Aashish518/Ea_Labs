...
import { FlaskConical, Menu, X, Home, ClipboardList, FileText, Calendar, Images } from "lucide-react";
...
const sidebarItems = [
    ...
    { icon: Images, label: "Slider Images", id: "sliderimages", path: "/sliderimages" },
