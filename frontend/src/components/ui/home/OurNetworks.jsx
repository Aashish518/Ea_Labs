...
const locations = [
  {
    ...
    name: "Ahmedabad",
    address:
      "108, Westface, Hebatpur Rd, near Baghban Party Plot, Thaltej, Ahmedabad, Gujarat 380059",
    phone: "9099045241",
  ...
  },
  {
    ...
    name: "Gwalior",
    address:
      "7, City Center, Near Railway Station, Gwalior, Madhya Pradesh 474002",
    phone: "8765432109",
...
export default function OurNetworks() {
  ...
  return (
    <section className="bg-gray-200 w-full py-12 px-4 sm:px-8">
      <div className="max-w-7xl mx-auto">
        ...
        >
          ...
          <p className="mt-2 text-lg text-gray-600">
            Our single goal: fast, accurate, affordable diagnostics for every
            patient.
          </p>
        </motion.div>
          ...
          >
            ...
            {locations.map((loc) => (
              <Button
                ...
                className={`absolute transform -translate-x-1/2 -translate-y-1/2 p-1 transition-transform duration-300 ${selectedLocation.id === loc.id ? "scale-125" : "scale-100"
                  } hover:scale-110`}
                aria-label={`Show details for ${loc.name}`}
              >
                <Icon
                  path={locationPath}
                  className="h-3 w-3 sm:h-6 sm:w-6 text-red-500 shrink-0"
                />
